...
class Actividad{
    ...
    public:
        ...
        /*FUNCIONES*/
        void crearActividad(std::string nombre,std::string lugar,std::string fecha, std::string publico,int aforo,std::string ponentes,float precio,int hora,std::string tipoActividad);
        //void eliminarActividad(std::string nombre);
        ...
        void busquedaActividad(std::string nombre);
