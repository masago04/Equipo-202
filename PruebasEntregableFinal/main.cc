...
void menuDirectorAcademico(DirectorAcademico da, GestorDeUsuarios gestor, Organizador organizador, Usuario user){
    ...
    bool comprobarPublicitarCorreo, comprobarEliminarActividad;
        ...
        do{
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    comprobarEliminarActividad=da.eliminarActividad(nombre_actividad);
                    if(comprobarEliminarActividad==true){
            ...
            std::cin.ignore();
                switch (opcion) {
                    case 1:
                        ...
                        comprobarAnadirUsuario=gestor.anadirUsuario(user);
                        if(comprobarAnadirUsuario==true){
                            std::cout<<"Usuario introducido con exito"<<std::endl;
                        }
                        else{
                            std::cout<<"\nEl dni introducido ya esta registrado en nuestra Base de Datos"<<std::endl;
                            std::cout<<"\nNo se ha realizado el registro del usuario"<<std::endl;
                        }
                        std::cout << "\n\nPresiona cualquier tecla para continuar..." << std::endl;
                        getchar();
                        getchar();
